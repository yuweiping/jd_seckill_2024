...
### 更新说明：
2024/5/5  **此版本不能用了，提交订单时增加了h5st4.7的参数**

2024/3/28  **此版本不再更新了**，后续的更新只在捐赠的小圈子里发布了。
...
### 支持
1. 右上角star支持一下
2. 如果各位老板需要联系我支持，请**打赏后再加微信,有最低要求**（小号s84iis）并注明已捐赠。**加我前请熟读此readme** 。
3. 小圈子有打包好的可用版本，但不提供源码了。


<img src=".\doc\微信图片_20240519211952.jpg"  />
